...
export class LanguageService {
    ...
    public async getByAlpha3Code(code: string): Promise<Language> {
        if (code.length !== 3) throw new ValidationException(`Language alpha 3 code must be with 3 symbols`);
    ...
    public async getByAlpha1Code(code: string): Promise<Language> {
        if (code.length !== 2) throw new ValidationException(`Language alpha 1 code must be with 2 symbols`);
